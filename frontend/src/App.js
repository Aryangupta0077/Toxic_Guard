  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route exact path="/comments" element={<Comments videoId={videoId}/>}/>
        <Route exact path="/posts" element={<Protected Component={Posts} setBtnVal = {setBtnVal} logBtn={logBtn} setId = {setId}/>}/>

        ...
        <div className="landingContent">
          ...
          initial={{ opacity: 0 }}
            ...
            <p>
              ...
              comments on users' posts across various social media platforms.
              This innovative tool employs cutting-edge natural language
              processing (NLP) and machine learning algorithms to analyze and
              identify potentially harmful or offensive content in real-time.
            </p>
          </motion.div>
        </div>
